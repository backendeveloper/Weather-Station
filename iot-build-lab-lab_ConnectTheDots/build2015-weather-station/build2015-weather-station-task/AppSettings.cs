...
namespace build2015_weather_station_task
{
    ...
    public sealed class AppSettings
    {
        ...
        const string ServicebusNamespaceDefault = "servicebusoniot-ns";
        const string EventHubNameDefault = "ehdevices";
        const string KeyNameDefault = "D1";
        const string KeyDefault = "sNsoPPoPoHlnfTB7dTdav16eSPSY4/P2Tw1j9LLieLk=";
        const string DisplayNameDefault = "minwinpc";
        const string OrganizationDefault = "Microsoft-IOT";
        const string LocationDefault = "Turkey";
